...
logrd="data/caf_"+sys.argv[1]+"_"+sys.argv[2]+"/"
...
for n in range(1,N+1):
    ...
    value+=a*delta1*feat(state1)

    theta[state2,action2]+=(1/(pstep[state2,action2]//K+1)**beta)*(reward2+gamma*np.dot(value,feat(next_state2))-np.dot(value,feat(state2)))
