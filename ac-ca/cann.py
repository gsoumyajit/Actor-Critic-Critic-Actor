...
logrd="data/cann_"+sys.argv[1]+"_"+sys.argv[2]+"/"
...
vscheduler=LambdaLR(voptim,lambda n:1/(n//K+1)**alpha)
...
for n in range(1,N+1):
    ...
    theta[state2,action2]+=(1/(pstep[state2,action2]//K+1)**beta)*(reward2+gamma*value(feat(next_state2)).detach()-value(feat(state2))).item()
