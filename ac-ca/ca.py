...
logrd="data/ca_"+sys.argv[1]+"_"+sys.argv[2]+"/"
...
for n in range(1,N+1):
    ...
    value[state1]+=(1/(vstep[state1]//K+1)**alpha)*(reward1+gamma*value[next_state1]-value[state1])
    theta[state2,action2]+=(1/(pstep[state2,action2]//K+1)**beta)*(reward2+gamma*value[next_state2]-value[state2])
    vstep[state1]+=1
