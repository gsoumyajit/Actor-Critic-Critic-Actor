...
if an%2==0:
    print("Executing 1.actor critic")
    pscheduler=LambdaLR(poptim,lambda n:1/(n//1000+1))
    vscheduler=LambdaLR(voptim,lambda n:np.log(n//1000+2)/(n//1000+2))
else:
    print("Executing 2.actor critic")
    vscheduler=LambdaLR(poptim,lambda n:1/(n//1000+1))
    pscheduler=LambdaLR(voptim,lambda n:1/(np.log(n//1000+2)*(n//1000+2)))
